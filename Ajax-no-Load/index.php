...
<head>
    ...
    <title>CRUD PHP &amp; MySQLi no loading</title>
...
<body>
    ...
    <div class="container">
        <h3 style="text-align:center; margin: 25px;">CRUD Ajax No Loading</h3>
        ...
        <form method="post" class="form-data" id="form-data">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <select name="jurusan" id="jurusan" class="form-control" required="true">
                            ...
                            <option value="Teknik Eletronika Industri">Teknik Eletronika Industri</option>
                        </select>
                ...
                <div class="form-group">
                    <button type="button" name="simpan" id="simpan" class="btn btn-outline-primary">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#simpan").click(function() {
                    ...
                    if (nama_siswa=="") {
                        document.getElementById("err_nama_siswa").innerHTML = "Nama Siswa/i Wajib Diisi";
                    } else {
                        document.getElementById("err_nama_siswa").innerHTML = "";
                    }
                    if (alamat=="") {
                        document.getElementById("err_alamat").innerHTML = "Alamat Lengkap Siswa/i Wajib Diisi";
                    } else {
                        document.getElementById("err_alamat").innerHTML = "";
                    }
                    if (jurusan=="") {
                        document.getElementById("err_jurusan").innerHTML = "Jurusan Siswa/i Wajib Diisi";
                    } else {
                        document.getElementById("err_jurusan").innerHTML = "";
                    }
                    if (tanggal_masuk=="") {
                        document.getElementById("err_tanggal_masuk").innerHTML = "Tanggal Masuk Siswa/i Wajib Diisi";
                    } else {
